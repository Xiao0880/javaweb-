    ...
    <div class="container">
        <div class="form-container">
            ...
            <form action="admin_book_update.do" method="post">
                ...
                <input type="date" id="publish_date" name="publish_date" value="<%= book.getPublishDate() %>" required>
                
                <label for="isbn">ISBN：</label>
                <input type="text" id="isbn" name="isbn" value="<%= book.getIsbn() %>" required>
                
                <label for="type_id">类型ID：</label>
                <input type="number" id="type_id" name="type_id" value="<%= book.getTypeId() %>" required>
