    ...
    <div class="container">
        <div class="search-container">
            ...
            <form action="admin_book_search.do" method="get" class="search-box">
                <input type="text" name="search_text" placeholder="按书名、作者、ISBN搜索..." value="<%= searchText != null ? searchText : "" %>">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="admin_book_search.do" method="post" style="display: inline;">
                            ...
                            <input type="hidden" name="book_id" value="<%= book.getBookId() %>">
                            <input type="hidden" name="search_text" value="<%= searchText != null ? searchText : "" %>">
                            <button type="submit" class="delete-link" onclick="return confirm('确定要删除该图书吗？');">删除</button>
                        </form>
                    </td>
                </tr>
                <% } %>
